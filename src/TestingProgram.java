...
public class TestingProgram {
    ...
    public void chessPieceClassTest() {
        ...
        Assert.assertTrue(check, "The ChessPiece class is incorrect");
    }
    ...
    public void horseClassTest() {
        ...
        Assert.assertTrue(check, "The Horse moved is incorrect");
    }
    ...
    public void pawnClassTest() {
        ...
        Assert.assertTrue(check, "The Pawn moved is incorrect");
    }
    ...
    public void bishopClassTest() {
        ...
        Assert.assertTrue(check && bishop.getSymbol().equals("B") && bishop.getColor().equals("Black"), "The Bishop moved is incorrect");
    }
    ...
    public void rookClassTest() {
        ...
        Assert.assertTrue(check && rook.getSymbol().equals("R") && rook.getColor().equals("White"), "The Rook moved is incorrect");
    }
    ...
    public void queenClassTest() {
        ...
        Assert.assertTrue(check && queen.getSymbol().equals("Q") && queen.getColor().equals("White"), "The Queen moved is incorrect");
    }
    ...
    public void kingClassTest() {
        ...
        Assert.assertTrue(check && king.getSymbol().equals("K") && king.getColor().equals("White"), "The King moved is incorrect");
    }
    ...
    public void castlingTest() {
        ...
        Assert.assertTrue(check, "The castling7() is incorrect");
    }
}
